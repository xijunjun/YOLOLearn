...
def detect():
    ...
    weights=[
        # r'.\weights\last-230.pt'
        r'Z:\workspace\yoloplate\plate-exp20-last.pt'
    ]
    ...
    source=[
        ...
        # r'Z:\workspace\yoloplate\plate-test-data'
        r'Z:\workspace\yoloplate\test1k'
    ][0]

    dstroot=r'Z:\workspace\yoloplate\test1k-result'
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        cv2.imwrite(os.path.join(dstroot,os.path.basename(path)),im0s)
