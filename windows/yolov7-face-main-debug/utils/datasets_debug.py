...
class InfiniteDataLoaderDebug(torch.utils.data.dataloader.DataLoader):
...
class _RepeatSamplerDebug(object):
...
class LoadImagesAndLabelsDebug(Dataset):  # for training/testing
...
def load_mosaic(self, index):
    ...
    img4_ori=np.array(img4)
    labels4_ori=np.array(labels4)
    ...
    return img4, labels4 #, img4_ori, labels4_ori
